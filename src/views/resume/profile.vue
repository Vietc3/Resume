                ...
                <div :class="isNavOpen ? 'block': 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
                    <div class="text-sm sm:flex-grow">
                        <ul class="sm:flex justify-around mt-8 w-full md:mt-0 md:ml-auto md:w-3/4">
                            <li class="p-2 sm:p-0"><router-link to="/pages/profile">Education</router-link></li>
                            <li class="p-2 sm:p-0"><router-link to="/pages/profile">Skill</router-link></li>
                            <li class="p-2 sm:p-0"><router-link to="/pages/profile">Employment history</router-link></li>
                            <li class="p-2 sm:p-0"><router-link to="/pages/profile">Project</router-link></li>            
                        </ul>
                    </div>
                </div>
            </div>
...
export default {
  data() {
    return {
      ...
      userPoll: '',
      user_info: {
        profile_img: require("@/assets/images/resume/quocvietAvatar.jpg"),
      ...
      userLatestPhotos: [
        require("@/assets/images/resume/quocvietAvatar.jpg"),
      ...
      userPosts: [{
          ...
          isLiked    : true,
          text       : 'My name is Nguyen Kim Quoc Viet. I’m 22 years old and I’m single. I have just graduated from university in May 2019  with the major in Electronic communications. I got 4 month experience as an internship at Sun* Da Nang company. I like soccer and swimming. I’m a careful and hard-working person. I’m eager to learn new things and willing to work in team. I easily adapt to with new working environment and take initiative in work.',
          media      : [{img:require("@/assets/images/resume/quocvietAvatar.jpg")}],
          likes      : 145,
          comments   : 77,
          usersLiked : [
