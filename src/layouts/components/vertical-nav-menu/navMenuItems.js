...
export default [
...

  {
    ...
    icon: "PackageIcon",
    i18n: "WORKEXPERIENCES",
    items: [
      {
        url: null,
        name: "Employment History",
        icon: "GlobeIcon",
        i18n: "EmploymentHistory",
        submenu: [
          {
            url: '/experience/employment-history/AITT',
            name: "AITT",
            slug: "company-aitt",
            i18n: "AITT",
          },
          {
            url: '/experience/employment-history/GIHOT',
            name: "GIHOT",
            slug: "company-gihot",
            i18n: "GIHOT",
          },
...

      {
        ...
        submenu: [
          {
            url: '/experience/project/Oh-Store',
            name: "Oh Store",
            slug: "project-ohStore",
            i18n: "OhStore",
          },
          {
            url: '/experience/project/Kogi-Store',
            name: "Kogi Store",
            slug: "project-kogiStore",
            i18n: "Kogi Store",
          },
          {
            url: '/experience/project/Kogi-Web',
            name: "Kogi Web",
            slug: "project-kogiWeb",
            i18n: "Kogi Web",
          },
          {
            url: '/experience/project/GMS-Application',
